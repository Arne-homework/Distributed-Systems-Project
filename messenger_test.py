...
class TestConnection(ut.TestCase):
    ...
    def test_simple_send(self):
        ...
        conn = Connection(0, 1, out_queue, self.make_messenger_message_factory(0, 1))
        ...
        self.assertEqual(
            message.get_content(),
            {
                "source": 0,
                "destination": 1,
                "content": {"typ": "content", "value": 1, "content": "Hello World"},
            },
        )
...
class TestMessenger(ut.TestCase):
    ...
    def test_delivery_with_unreliable_transport3(self):
        ...
        transports = [
            UnreliableTransport(
                messenger_0.out_queues[1], messenger_1.in_queue, randomizer
            ),
            UnreliableTransport(
                messenger_1.out_queues[0], messenger_0.in_queue, randomizer
            ),
        ]
    ...
    def test_delivery_with_unreliable_transport1(self):
        ...
        transports = [
            self._make_unreliable_transport(
                messenger_0.out_queues[1], messenger_1.in_queue, randomizer_0
            ),
            self._make_unreliable_transport(
                messenger_1.out_queues[0], messenger_0.in_queue, randomizer_1
            ),
        ]
        transports[0].set_drop_rate(0.5)
        content = "Hello 1"
